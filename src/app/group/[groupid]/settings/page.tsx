import GroupSettingForm from "@/components/forms/group-settings";

type Props = {};

const GroupSettingPage = ({ params }: { params: { groupid: string } }) => {
    return (
        <div className="flex flex-col w-full h-full gap-10 px-16 py-10 overflow-auto"> 
            ...
            <GroupSettingForm groupId={params.groupid}/>
        </div>
    )
};
