...
import GraidentText from "@/components/global/gradient-text";
...
export const PricingSection = (props: Props) => {
    return (    
    <div className="w-full pt-20 flex flex-col items-center gap-3"
        id="pricing"
    >
        ...
        <Card className="p-7 mt-10 md:w-auto w-full bg-themeBlack border-themeGray">
            <div className="flex flex-col gap-2">
                ...
                <CardDescription className="text-[#B4B0AE]">Great if you are just getting Started</CardDescription>
